...
ActiveRecord::Schema.define(version: 20160925001441) do
  ...
  create_table "user_medications", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["medication_id"], name: "index_user_medications_on_medication_id", using: :btree
    t.index ["user_id"], name: "index_user_medications_on_user_id", using: :btree
  end
